...
const userSchema = new mongoose.Schema({
  ...
  role: { type: String, enum: ["user", "client", "agent", "admin", "employee"], default: "user" },
...
const bookingSchema = new mongoose.Schema({
  ...
  operatingDays: { type: String, trim: true, default: "" },
  ...
  status: { type: String, enum: ["new", "inquiry", "needs discussion", "ongoing", "cancelled"], default: "new" },
...
const orderProgressSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ["inquiry", "planned", "in progress", "completed", "blocked"], default: "completed" },
  callLog: { type: String, trim: true, default: "" },
  progressPercent: { type: Number, min: 0, max: 100, default: 0 },
